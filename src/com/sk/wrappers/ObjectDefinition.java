...
public class ObjectDefinition extends ProtocolWrapper<ObjectDefinitionLoader> {
	...
	static {
		...
		new BasicProtocol(new FieldExtractor[]{new FieldExtractor(new StaticExtractor(null))}, 21, 22, 23, 27, 62, 64, 73, 82, 88, 89, 91, 94, 97, 98, 103, 105, 168, 169, 177, 189, 198, 199, 200).addSelfToGroup(protocol);
		...
		new BasicProtocol(new FieldExtractor[]{new FieldExtractor(new StaticExtractor(false), "walkable")}, 17, 18).addSelfToGroup(protocol);
