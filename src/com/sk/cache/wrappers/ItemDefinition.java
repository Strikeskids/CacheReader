...
public class ItemDefinition extends ProtocolWrapper<ItemDefinitionLoader> {
	...
	static {
		...
		new ArrayProtocol(ParseType.UBYTE, new FieldExtractor[]{new FieldExtractor(ParseType.USHORT), new FieldExtractor(ParseType.USHORT)}, 40).addSelfToGroup(protocol);
		new BasicProtocol(new FieldExtractor[]{new FieldExtractor(ParseType.USHORT, "noteId")}, 97).addSelfToGroup(protocol);
		new ArrayProtocol(ParseType.UBYTE, new FieldExtractor[]{new FieldExtractor(ParseType.USHORT)}, 132).addSelfToGroup(protocol);
		new BasicProtocol(new FieldExtractor[]{new FieldExtractor(ParseType.STRING, "name")}, 2).addSelfToGroup(protocol);
		new ArrayProtocol(ParseType.UBYTE, new FieldExtractor[]{new FieldExtractor(ParseType.SHORT), new FieldExtractor(ParseType.SHORT)}, 41).addSelfToGroup(protocol);
